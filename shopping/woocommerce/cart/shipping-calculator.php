...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h2><a href="#" class="shipping-calculator-button btn btn-default btn-shipping"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a></h2>
		...
		<div class="form-group form-row-wide">
			<?php
				...
				// Dropdown Input
					...
					?><span>
						<select name="calc_shipping_state" id="calc_shipping_state" placeholder="<?php _e( 'State / county', 'woocommerce' ); ?>" class="form-control">
